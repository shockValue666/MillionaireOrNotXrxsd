...
const Balance: React.FC = () => {
  ...
  return (
    <div className='relative'>
        <div className="absolute top-20 left-4 md:top-0 md:left-10 bg-indigo-600 text-white py-2 px-4 rounded-lg shadow-xl flex items-center text-sm md:text-base">
