...
import { hookTransactions, privateTab, profiles, subscriptions, users, emojiSlot,doubleEmojiSlots,tripleEmojiSlots, ads, cumBets, dexScreenerPair } from "../../../migrations/schema"
  ...
  public: {
    Tables: {
      achievements: {
        ...
        Relationships: [
          {
            foreignKeyName: "achievements_user_id_profiles_id_fk"
            columns: ["user_id"]
            isOneToOne: false
      ...
      transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "transactions_coin_id_coins_id_fk"
            columns: ["coin_id"]
            isOneToOne: false
...
> = PublicEnumNameOrOptions extends { schema: keyof Database }
  ...
  export type HookTransaction = InferSelectModel<typeof hookTransactions>
...
export type CumBet = InferSelectModel<typeof cumBets>

export type DexScreenerPair = InferSelectModel<typeof dexScreenerPair>